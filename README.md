![Logo](https://i.imgur.com/hIkpB0G.png)
# Discount Coin Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Discount Coin Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/DXrH4YN)
***
## Requirements
1) **5,000 Discount coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Discount-Coin/master/discount_install.sh`
***
...
***Step 1***
* Download and install the Discount Coin wallet [here](https://discountco.in/)
***

***Step 2***
* Send EXACLY 5,000 DSC to a receive address within your wallet.
***
